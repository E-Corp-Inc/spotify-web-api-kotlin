...
public class JPEGDecoder {
    ...
    public class Adobe(
        ...
        public val flags0: Int,
        public val flags1: Int,
        public val transformCode: Boolean
    )
    ...
    public data class HuffmanNode(var children: ArrayList<Any> = arrayListOf(), var index: Int = 0) {
        public fun setChildAt(index: Int, value: Any) {
    ...
    public class FrameComponent(
        public val h: Int,
        public val v: Int,
        public var quantizationIdx: Int
    ) {
        public var huffmanTableDC: List<Any> = emptyList()
        public var huffmanTableAC: List<Any> = emptyList()
        public var quantizationTable: IntArray = IntArray(0)
        public var pred: Int = 0
        public var blocksPerLine: Int = 0
        public var blocksPerColumn: Int = 0
        public var blocks: List<List<IntArray>> = emptyList()
    }
    ...
    public class Frame(
        ...
        public var scanLines: Int,
        public var samplesPerLine: Int,
        public var components: ArrayList<FrameComponent>,
        public var componentsOrder: ArrayList<Int>,
        public var maxH: Int = 0,
        public var maxV: Int = 0
    ) {
        public var mcusPerLine: Int = 0
        public var mcusPerColumn: Int = 0
    }

    public fun parse(data: UByteArrayInt) {
        var offset = 0
    ...
    public class Component(public val lines: List<UByteArrayInt>, public val scaleX: Float, public val scaleY: Float)
    ...
    public fun copyToImageData(imageData: ImageData) {
    ...
    public class ImageData(public val width: Int, public val height: Int, public val data: UByteArrayInt)

    public companion object {
        public fun decodeInfo(jpegData: ByteArray): ImageInfo {
            val arr = UByteArrayInt(jpegData)
            val decoder = JPEGDecoder()
            decoder.parse(arr)
            return ImageInfo(decoder.width, decoder.height)
        }

        public fun decode(jpegData: ByteArray): Bitmap32 {
